<nav class="navbar">
    ...
    <div class="navbar__mobile">
        <div class="navbar__mobile-btns">
            ...
            <?php
                if ($userId !== '') {
                    echo '<button class="navbar__mobile-btns-btn" onclick="location.href=\'#\'"><i class="fa-solid fa-power-off"></i></button>';
                }
            ?>
        </div>
        <a href="#stats" class="navbar__mobile-item deactive">statystyki</a>
    ...
    <div class="navbar__desktop">
        ...
        <a href="#stats" class="navbar__desktop-item">statystyki</a>
